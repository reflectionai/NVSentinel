...
"""Configuration for NCCL group collectives preflight check."""
...
DEFAULT_BW_THRESHOLD_GBPS = 300.0
DEFAULT_GANG_TIMEOUT_SECONDS = 600
DEFAULT_MESSAGE_SIZES = "16G"
...
DEFAULT_DEEPEP_DISPATCH_THRESHOLD_GBPS = 50.0  # TODO(jin): tune it
DEFAULT_DEEPEP_COMBINE_THRESHOLD_GBPS = 50.0  # TODO(jin): tune it
DEFAULT_DEEPEP_TOTAL_THRESHOLD_GBPS = 150.0  # TODO(jin): tune it
