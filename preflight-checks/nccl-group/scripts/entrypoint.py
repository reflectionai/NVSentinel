...
"""Entrypoint script for NCCL group collectives preflight check.
...
from nccl_group.errors import NCCLError
from nccl_group.gang import GangConfig, GangWaiter
from nccl_group.health import HealthReporter
from nccl_group.logger import set_default_structured_logger
from nccl_group.protos import health_event_pb2 as pb
...
def main() -> int:
    ...
    set_default_structured_logger("preflight-nccl-group", "0.1.0", log_level)
    ...
    log.info(
        "Starting NCCL group collectives preflight check",
        extra={
